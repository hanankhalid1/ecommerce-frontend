...
const ShopCartLikes = ({ heading, backgroundColor }: any) => {
  return (
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-wrap justify-between text-[#425A8B] items-center mb-4">
          ...
          {categories.map((category: any) => (
            <button
              key={category.id}
              className={`px-4 py-2 text-[#425A8B] hover:text-[#425A8B] transition-colors ${
                activeTab === category.id ? "text-[#425A8B] font-semibold" : ""
              }`}
